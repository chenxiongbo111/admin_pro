...
function getDataList() {
    ...
    $.get(baseUrl + '/user/getUserList', data, function (res) {
        console.log(res)
        totalBut = res.total;
        var strHtml = `<tr>
    <td>#</td>
        ...
        $(".block").click(function () {
            ...
            layer.open({
                ...
                , yes: function (index, layero) {
                    ...
                    $.post(baseUrl + '/user/updateUser', obj, function (res) {
                        console.log(res)
                        foo()
                        flag = true;
                        layer.msg('禁用成功', {
        ...
        $(".delect").click(function () {
            ...
            layer.open({
                ...
                , yes: function (index, layero) {
                    ...
                    $.post(baseUrl + '/user/removeUser', obj, function (res) {
                        console.log(res)
                        foo()
                        flag = true;
                        layer.msg('删除成功', {
                    ...
                    var index = layer.open({
                        ...
                        btn1: function (index, layero) {
                           ...
                           var newObj ={
                            ...
                            console.log(obj)
                            $.post(baseUrl+'/user/updateUser',newObj,function(res){
                                console.log(res)
                            layer.close(index);
                                flag =true;
                                foo()
    ...
    var index = layer.open({
        ...
        btn1: function (index, layero) {
            ...
            if (!($(".account").val()) || !($(".password").val())) {
                ...
                $.post(baseUrl + '/user/addUser', obj, function () {
                    console.log(obj)
                    foo()
